 ...
 * - typed: 入力欄に打ちかけの文字がある。「消して送る」（C-u で消してから同じ本文）か「別プロセスで送る」
  ...
  return (
    <div className="notice confirm" role="alertdialog" aria-live="polite">
      ...
      <div className="actions">
        ...
        <button type="button" className={confirm.kind === 'typed' ? 'linkish' : 'primary'} onClick={onProcess} title="端末を見ずに claude -p --resume / codex exec resume で 1 ターン回す。端末には出ず、端末で開いている会話はこのターンを知らない">
          別プロセスで送る
        </button>
