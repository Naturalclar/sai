...
export const AGENT_LABEL: Record<string, string> = { claude: 'Claude Code', codex: 'Codex CLI', opencode: 'OpenCode', grok: 'Grok Build', unknown: 'unknown' }
export const AGENT_INITIAL: Record<string, string> = { claude: 'C', codex: 'X', opencode: 'O', grok: 'G', unknown: '?' }
